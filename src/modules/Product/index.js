            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                <div className="flex">
                  ...
                  <button className="border-2 border-gray-300 ml-1 bg-lime-500 rounded-full w-6 h-6 focus:outline-none"></button>
                </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className=' flex'>
                  <button className="flex ml-auto text-black bg-lime-300 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-500 rounded mr-2" onClick={() => handleCart(product, true)}>Buy it now</button>
                  <button className="flex ml-auto border border-indigo-500 py-2 px-6 focus:outline-none hover:bg-yellow-500 hover:text-white rounded" onClick={() => handleCart(product)}>Add to cart</button>
                </div>
