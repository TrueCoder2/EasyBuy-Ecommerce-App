    ...
    <div className="container ">
      <div className="flex shadow-md my-10">
        <div className="w-3/4 bg-white px-10 py-10">
          ...
          <Link to={'/products'} className="flex font-semibold text-black text-sm mt-10">
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          ...
          <div className="border-t mt-8">
            ...
            <button className="bg-yellow-300 font-semibold hover:bg-yellow-400 py-3 text-sm text-black uppercase w-full">Checkout</button>
          </div>
        </div>
